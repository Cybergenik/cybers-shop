...
<body id="bg">
    ...
    <?php elseif(isset($_SESSION['auth'])):?>
        <h2 style='color: #ff7a7a;'>Welcome to <u>Cyber's</u> Gamer Shop</h2>
        <br><br><h2>Gamers Choices:</h2><br>
        <div class='flex-container2'>
        <?php
        //Loading data for Graphs into JS
        ...
        <br><div id='mobasContainer' style='height: 370px; width: 50%; text-color: white;'></div>
            <script>
            ...
            <br><br><div id='shootersContainer' style='height: 370px; width: 50%; color: white;'></div>
            <script>
